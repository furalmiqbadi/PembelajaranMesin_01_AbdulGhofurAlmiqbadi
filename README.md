...
<h1 align="center">Pembelajaran Mesin</h1>
...
- [x] **Week 6** — [`UTS`](./JS06/) 
- [x] **Week 7** — [`Praktikum`](./JS07/) 
- [x] **Week 8** — [`Praktikum`](./JS08/) 
- [x] **Week 9** — [`Praktikum`](./JS09/) 
- [x] **Week 10** — [`Praktikum`](./JS10/) 
- [x] **Week 11** — [`Praktikum`](./JS11/) 
- [x] **Week 12** — [`Praktikum`](./JS12/) 
- [x] **Week 13** — [`Praktikum`](./JS13/) 
- [x] **Week 14** — [`UAS`](./JS14/) 
- [x] **Week 15** — [`Praktikum`](./JS15/) 
- [x] **Week 16** — [`Pengumpulan Akhir`](./pengumpulan-akhir) 
- [x] **Complete** — `All Tasks Done`  -->
 - [ ] **Soon**  ⏳

---

<div align="center">
  <sub>Repository Tugas - Pembelajaran Mesin - Semester 5</sub>
</div>
